  ...
  return (
    <section id="ministries" className="py-16 md:py-24 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-8">주요 사역 보고</h2>
...
const MinistryCard = ({ ministry, scrollToSection }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 transform transition duration-300 hover:translate-y-[-5px] border-t-4 border-indigo-500">
      ...
      <h3 className="text-xl font-semibold text-gray-800 mb-4">{ministry.title}</h3>
